...
<script src="{{ asset('/') }}public/frontend/js/isotop.js"></script> 
<script src="{{ asset('/') }}public/frontend/js/snackbar.min.js"></script> 
<script src="{{ asset('/') }}public/frontend/js/simplebar.js"></script> 
<script src="{{ asset('/') }}public/frontend/js/parallax.js"></script> 
<script src="{{ asset('/') }}public/frontend/js/scrollto.js"></script> 
<script src="{{ asset('/') }}public/frontend/js/jquery-scrolltofixed-min.js"></script> 
<script src="{{ asset('/') }}public/frontend/js/jquery.counterup.js"></script> 
<script src="{{ asset('/') }}public/frontend/js/wow.min.js"></script> 
<script src="{{ asset('/') }}public/frontend/js/progressbar.js"></script> 
<script src="{{ asset('/') }}public/frontend/js/slider.js"></script>

<script src="{{ asset('/') }}public/frontend/js/timepicker.js"></script> 
<script src="{{ asset('/') }}public/frontend/js/wow.min.js"></script> 
