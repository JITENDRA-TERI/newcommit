				  ...
				  <div class="col-sm-12" style="margin-bottom:20px;">
				     <div class="row">
						...
						<div class="col-sm-3">
						   ...
						   <i class="icon-plus">
						   <a href="{{ route('add-gallery-image') }}">Add Gallery</a></i></button>
						</div>
					</div>
				  </div>
                      ...
                      <tbody id="media-table">
					   ...
					   @foreach ($gallery as $bl)
                        ...
                        <tr id="{{ $bl->id }}">
						 ...
						 <td>
						 <img src="{{ asset('/') }}public/gallery_images/{{$bl->image_name}}" style="width:20%; height:30%; border-radius:1%;">
						</td>
