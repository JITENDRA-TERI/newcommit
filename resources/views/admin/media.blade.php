				  ...
				  <div class="col-sm-12" style="margin-bottom:20px;">
				     <div class="row">
						...
						<div class="col-sm-3">
						   ...
						   <i class="icon-plus">
						   <a href="{{ route('add-media') }}">Add Media Post</a></i></button>
						</div>
					</div>
				  </div>
                      ...
                      <tbody id="media-table">
					   ...
					   @foreach ($getmedia as $bl)
                        <tr id="{{ $bl->id }}">
                          ...
                          <td> {{ date("F j, Y"),strtotime($bl->post_date) }} </td>
						  <td> {{ $bl->author }} </td>
						  ...
						  <td> <a href="media/edit/{{ $bl->id }}"><button type="button" class="btn btn-primary btn-rounded btn-icon">
